...
public class Product implements Serializable{
	...
	// Metodo construtor obs: Não se coloca uma coleção no construtor porque ja esta instanciada
	...
	// Metodos Gets e Sets - Obs: Não há metodo set para coleções
	public Long getId() {
		return id;
	}
	...
	@JsonIgnore   // Evita que a chamada GET no Postman fique em loop
