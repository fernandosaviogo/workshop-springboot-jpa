...
import com.fernandoweb.course.entities.Payment;
import com.fernandoweb.course.entities.Product;
import com.fernandoweb.course.entities.User;
import com.fernandoweb.course.entities.enums.OrderStatus;
import com.fernandoweb.course.repositories.CategoryRepository;
import com.fernandoweb.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {   // Será executado no inicio do programa
		...
		categoryRepository.saveAll(Arrays.asList(cat1, cat2, cat3));   // salva os dados no banco
		productRepository.saveAll(Arrays.asList(p1, p2, p3, p4, p5));
		
		// Associação dos produtos a suas devidas categorias
		...
		orderRepository.saveAll(Arrays.asList(o1, o2, o3));   // salva os dados no banco
		
		// Associação das Order(pedido) com o Produto
		...
		o1.setPayment(pay1);   // Associação de mão dupla em memoria, associa o pedido ao pagamento
		
		orderRepository.save(o1);   // Salva no banco de dados,  salva o pedido e o JPA sala o pagamento
	}
